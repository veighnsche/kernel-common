...
static int bbr_update_ecn_alpha(struct sock *sk)
{
	...
	/* Skip updating alpha only if not ECN-eligible.
	 * TEAM_027: PLB sysctl removed - not available in kernel 6.1
	 */
	...
	/* TEAM_027: TCP_PLB_SCALE not in 6.1, but BBR_SCALE == 8 is correct */
...
/* TEAM_027: BTF_KFUNCS_START not available in kernel 6.1, use BTF_SET8_START */
